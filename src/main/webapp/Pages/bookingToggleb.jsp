...
<body>
	...
	<div class="popup" id="popup">
		...
		<a href="boxes.jsp" class="close-btn">X</a>
		...
		<form action="../bookBoxSlot" method="post">
			...
			<%
				...
				List<Sloatb> bli = dao.getSlotById(id);
				for(Sloatb b: bli){
			%>
				<li>
					<input class="styled-checkbox" id="styled-checkbox-1" type="checkbox" name="sloatb" value="<%=b.getTimeFrom()%> <%=b.getTimeTo() %>" > 
					<label for="styled-checkbox-1"><%=b.getTimeFrom()%> to <%=b.getTimeTo() %></label>
					<input type="hidden" name="ownerId" value="<%=b.getSlotOwnerId()%>">
				</li>
				<%} }%>
			</ul>
