		...
		<div class="navigaction">
			<div class="nav-items">
				<a class="item" href="index.jsp">Home</a> <a class="item"
					href="Pages/ground.jsp">Grounds</a> <a class="item"
					href="Pages/boxes.jsp">Boxes</a> <a class="item"
					href="Pages/umpire.jsp">Umpires</a>
				<%
				if (user == null && umpire == null) {
				%>
				<a class="btn item" href="Pages/ownerRegister.jsp">Register</a> <a
					class="btn item" href="Pages/login.jsp">Login</a>
				<%
